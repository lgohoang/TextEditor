...
namespace TextEditor.Controllers
{
    public class PageFormatController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,MarginLeft,MarginRight,MarginTop,MarginBottom,PaperType,FontFamily")] PageFormat pageFormat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,MarginLeft,MarginRight,MarginTop,MarginBottom,PaperType,FontFamily")] PageFormat pageFormat)
        {
            if (ModelState.IsValid)
            {
